                        ...
                        <div class="col-md">
                            <div class="card mb-4 mb-lg-0">
                                <div class="card-body d-flex justify-content-between align-items-center p-3">
                                    <p class="mb-0">PET<?php echo $data['ID_PET']; ?></p>
                                    <i class="fa-solid <?php echo $class;?> fa-lg" style="color: <?php echo $color_pet;?>;"></i>
                                    <p class="mb-0"><?php echo $data['NAME_PET']; ?></p>
                                    <p class="mb-0"><?php echo $data['RAZA_PET']; ?></p>
